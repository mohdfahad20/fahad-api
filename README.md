...
* Switch to ✦ AI mode
* Ask: "What projects has yourname built?"
...
Create a new repo on GitHub (do NOT add README, .gitignore — you already have them)

```bash
git remote add origin https://github.com/YOUR_USERNAME/yourname-portfolio.git
git branch -M main
...
4. Import your `yourname-portfolio` repo
...
Your portfolio is live at `https://yourname-portfolio.vercel.app`
